...
export const updateTableRequest = (update) => {
  return (dispatch) => {
    ...
    fetch(`${API_URL}/tables/${update.id}`, options).then((res) => {
      console.log(res);
      dispatch(editTable(update));
    });
  };
};
...
//dispatch w  fetchTable mamy dzieki palginowi redux-thunk, (spawrdz opis fetchpwania)
